...
clubNights:
  heading: Run with us
  intro: We meet twice a week at Chard Cricket Club. Turn up, say hello, and run with people going your speed.
  nights:
    - day: Tuesday
      time: 7:00pm
      ...
      detail: |-
        Four mile town loop at a relaxed pace, one or two groups around the 10km mark, about 13km with at least one hill then a 10-13 mile group. Showers and the bar afterwards.

        Groups always loop back at junctions to the slowest runner, great if you move up to a faster group. If you’re always looping back it might be time to move up a group. 
...
ourRaces:
  heading: Our races
  intro: The club puts on two races a year. Both are run by members, and both need marshals.
