...
status: "retired"
dateConfirmed: false
lastSeen: 2017-09-09   # the date we have evidence for, from a club race report
championship: false   # TODO confirm which races count
# entryUrl: add when entries open
---

White Star Running, Burnbeck near Corfe Castle. 12-hour timed lapped event, prizes for distance rather than speed.
